...
%cutVect           = @(vector, st, nd) vector(st : nd);
%vectIndex         = @(vector, index) vector(index);
...
% toolPth = '/Volumes/server/Projects/Temporal integration/temporalUtils/';
% codePth = '/Volumes/server/Projects/Temporal integration/Stimulus/fMRIstimulus/';
% 
...
save_txt = sprintf('temporalExp2%d.mat', whichRun);

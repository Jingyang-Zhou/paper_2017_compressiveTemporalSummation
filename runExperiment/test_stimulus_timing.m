...
%data = load('~/Desktop/20160203T113847.mat');
data = load('~/Desktop/20180802T154538.mat');
...
axis tight,  title('Sample by sample difference','FontSize', 14)
ylabel('time(sec)'), xlabel('nth sample'), xlim([0,40]),
